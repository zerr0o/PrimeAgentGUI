...
**Version 3.2.3** · [Télécharger l’installateur Windows x64](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.2.3/Prime-Agent-Studio_3.2.3_x64-setup.exe) · [Historique des versions](docs/changelog.md).
