...
Run [Prime-Agent-Studio_3.0.1_x64-setup.exe](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.0.1/Prime-Agent-Studio_3.0.1_x64-setup.exe). Installation is limited to your Windows user and offers Start menu and desktop shortcuts. Node.js is included. The installer installs WebView2 when needed; this component may require an Internet connection.
