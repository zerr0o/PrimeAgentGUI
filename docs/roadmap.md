...
Les nouvelles exécutions du Studio et leurs sous-agents reçoivent six outils via l’extension native de Prime Agent 0.9.4. Aucun fork du moteur n’est nécessaire.
