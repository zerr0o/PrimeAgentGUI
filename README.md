...
**Version 3.2.3** · [Download the Windows x64 installer](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.2.3/Prime-Agent-Studio_3.2.3_x64-setup.exe) · [Release history](docs/en/changelog.md).
...
**After updating:** the application can keep using the previous server while agents finish. Once they have finished, use **Preferences → Updates → Restart server** in the Windows application to activate 3.2.3. [Update guide](docs/en/desktop.md).
